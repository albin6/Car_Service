...
<div class="w3l-table-info" style="margin-left: -320px; overflow-x: auto;">
					  <h2>View Registered Users</h2>
						...
						<tbody>
						  <?php
                                                  $qr="select  * from tbl_reg order by Id desc";
                                                  ...
                                                  ?>
                                                    ...
                                                    <td><?php echo $r['Phno'];?></td>
                                                     ...
                                                     {
                                                        ?>
                                                          <a href="approve_status.php?id=<?php echo $r['Id'];?>" class="btn btn-primary">Approve</a>  
                                                          <a href="approve_reject.php?id=<?php echo $r['Id'];?>" class="btn btn-success">Reject</a> 
                                                          <?php 
                                                     }

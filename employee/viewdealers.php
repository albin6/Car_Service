...
<div class="w3l-table-info" style="margin-left: -320px; overflow-x: auto;">
					  <h2>View Registered Users</h2>
						...
						<tbody>
						  <?php
                                                  $qr="select  * from tbl_dealer order by Id desc";
                                                  ...
                                                  ?>
                                                    ...
                                                    <td><?php echo $r['Phno'];?></td>
                                                     ...
                                                     {
                                                        ?>
                                                          <a href="approve_dealer_status.php?id=<?php echo $r['Id'];?>" class="btn btn-primary">Approve</a>  
                                                          <a href="approve_dealer_reject.php?id=<?php echo $r['Id'];?>" class="btn btn-success">Reject</a> 
                                                          <?php 
                                                     }
                                                     elseif ($r['Status']=='Approve') {
                                                     ?>
                                                 <a href="approve_dealer_reject.php?id=<?php echo $r['Id'];?>" class="btn btn-success">Reject</a> 
                                                 ...
                                                 <?php 
                                                     ...
                                                     ?> 
                                                       ...
                                                       <td><a href="del_dealer.php?id=<?php echo $r['Id'];?>"><input type="button" name="btn" value="delete" onclick="alert('are you sure want to delete??')"> </a></td>

                                          ...
                                          <div class="credit-card-wrapper">
                                             <div class="first-row form-group">
                                                 <div class="controls">
                                                   ...
                                                   <input class="billing-address-name form-control" type="number" required="" name="quantity" value="" id="q" onkeyup="multiply();"  />
                                                </div>
                                                 <div class="controls">
                                                ...
                                                <div class="w3_agileits_card_number_grids">
                                                   <div class="w3_agileits_card_number_grid_left">
                                                      <div class="controls">
                                                         ...
                                                         <input class="number credit-card-number form-control" id="cnumber" required="" onchange="validate_card()"  type="number" name="num"   placeholder="&#149;&#149;&#149;&#149; &#149;&#149;&#149;&#149; &#149;&#149;&#149;&#149; &#149;&#149;&#149;&#149;">
                                                            <script>
                                            ...
                                            alert('Must Enter 16 digit');
                                                   ...
                                                   <div class="w3_agileits_card_number_grid_right">
                                                      <div class="controls">
                                                         ...
                                                         <input class="security-code form-control" Â· inputmode="numeric" id="cvv" required="" onchange="validate_cvv()" type="number" name="security-code" placeholder="&#149;&#149;&#149;">
                                                      <script>
                                            ...
                                            alert('Must Enter 3 digit');
                                                ...
                                                <div class="controls">
                                                   ...
                                                   <input class="expiration-month-and-year form-control" type="date" name="exp" placeholder="MM / YY">
                                                </div>
                                             </div>

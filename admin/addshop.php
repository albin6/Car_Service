...
<div>
    <form class="form-horizontal" method ="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="number" class="form-control1" id="pin" required="" onchange="validate_pin()" name="pin"  value="" required="">
                                                                                    <script>
									...
									<div class="col-sm-8">
                                                                            <input type="number" class="form-control1" name="phone" id="cnumber"  onchange="validate_card()"  value="" required="">
                                                                              <script>

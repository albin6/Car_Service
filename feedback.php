		...
		<div class="contact-infhny py-5">
			<div class="container py-lg-5">
				<div class="grid contact-grids row">
					...
					<div class="col-lg-6 contacts12-main">
						    <form class="form-contact " action="" method="POST" id=""  enctype="multipart/form-data">
                            <div class="row">
                                 
                                <div class="col-12">
                                    <div class="form-group">
                                     <textarea class="form-control" name="complaint" id="name"    placeholder="Enter your Feedback" required=""></textarea>   
                                    </div>
                                </div>
         ...
         <?php
                    ...
                    if(isset($_POST['submit']))
                    {
                        ...
                        $qr1=mysqli_query($con,"insert into feedback(User_id,Complaint) values('$uid','$complaint')");
